const TextArea = ({ value, onChange, error, className, ...rest }: any) => {
  ...
  return (
    <div className="relative w-full">
      <textarea type="text" {...rest} className={"py-2.5 px-3 rounded-[5px] mt-1 w-full text-blue " + cls} value={value} onChange={onChange} />
